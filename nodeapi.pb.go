...
func (NodeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_nodeapi_5f6c7286029dcc1a, []int{0}
}
...
func (KeepAliveCommand) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_nodeapi_5f6c7286029dcc1a, []int{1}
}
...
func (*NodeUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_nodeapi_5f6c7286029dcc1a, []int{2}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_nodeapi_5f6c7286029dcc1a, []int{3}
}
...
func init() { proto.RegisterFile("nodeapi.proto", fileDescriptor_nodeapi_5f6c7286029dcc1a) }

var fileDescriptor_nodeapi_5f6c7286029dcc1a = []byte{
	// 619 bytes of a gzipped FileDescriptorProto
	,
}
